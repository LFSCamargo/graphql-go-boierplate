...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "TokenOutput.token":
		...
		return e.complexity.TokenOutput.Token(childComplexity), true
...
func (ec *executionContext) _TokenOutput_token(ctx context.Context, field graphql.CollectedField, obj *model.TokenOutput) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _TokenOutput(ctx context.Context, sel ast.SelectionSet, obj *model.TokenOutput) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "token":
			out.Values[i] = ec._TokenOutput_token(ctx, field, obj)
